...
### Emotion Graph
![Emotion Graph](images/emotion_graph.jpg)

### Goals
![Goals](images/goals.jpg)

### Tool History
![Tool History](images/tool_history.jpg)
...
- **Thought Summaries**: Review summaries of the agent's thought processes generated by an LLM that condenses the agent's complex thoughts into concise summaries
...
- Animated avatar with thought and speech bubbles for visualization
- Two-way chat interface for direct interaction with the agent
- Enhanced thought summary generation for more intuitive understanding of the agent's cognition
